    ...
    return (
        ...
        <Forms>
            ...
            <form action="" className="space-y-6">
                ...
                <div>
                    <label htmlFor="" className="text-sm font-bold text-azulBalanço block ">Digite o email: </label>
                    <input type="email" className="w-full p-2 border border-gray-300 rounded mt-1" />
                </div>
                <div>
                    <label htmlFor="" className="text-sm font-bold text-azulBalanço block">Digite a senha: </label>
