...
export default function PromoterSignUp() {
  return (
    <main
      className={`w-full h-screen flex flex-col items-center justify-center bg-[#0013a6] sm:px-4 ${font.className}`}
    >
      <Head>
      ...
      <div className="w-full space-y-6 text-[#4b5563] sm:max-w-md">
        <a href="http://localhost:3000/">
          <AiOutlineArrowLeft
            size="55"
            className="absolute top-8 left-10 rounded-lg text-[#f5f5f5] hover:text-gray-400"
          />
        </a>
        <div className="text-center">
          <Image className="mx-auto" src="/images/logo-complete-white.png" alt="Logo White" height="120" width="120" />
          <div className="mt-2 space-y-2">
            <h3 className="text-[#ffffff] text-xl font-bold sm:text-2xl">Torne-se Promoter</h3>
          </div>
        </div>
